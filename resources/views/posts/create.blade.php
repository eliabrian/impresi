        ...
        <div class="card-body">
            <form action="{{ route('post.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-8">
                        <div class="form-group">
                            <textarea id="content-text-area" class="form-control" name="content" id="content" rows="20"></textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input @error('published') is-invalid @enderror" name="published" id="published" value="1">
